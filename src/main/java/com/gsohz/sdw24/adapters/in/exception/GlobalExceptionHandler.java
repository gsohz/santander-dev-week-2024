package com.gsohz.sdw24.adapters.in.exception;
...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ApiError> handleDomainError(ChampionNotFoundException domainError) {
		return ResponseEntity.unprocessableEntity().body(new ApiError(domainError.getMessage()));
	}
	
	@ExceptionHandler(Exception.class)
	public ResponseEntity<ApiError> handleDomainError(Exception unexpectedError) {
